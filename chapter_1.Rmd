---
title: <br><br><br> Agreeing how uncertainty should be used to help answer the question
output:
  html_document:
    toc: true
    toc_float: true
...
<div class = "rightA">
  As well as clearly defining the question, we should also ensure that any important detailed questions to support the analysis are appropriately thought through. For example, in an education context we may be interested in uncertainty in both academic and financial years  
</div>
...
<div class = "rightA">
  It is also important to jointly identify sources of uncertainty that are so deep that little or nothing can be said quantitatively about their impact on the policy outcome. An exzmple might be the impact of a natural disaster on a particular policy. Deep uncertainties can have major implications for decision-making, and may call for a descriptive approach to the analysis and presentation of options.
</div>
...
<div class = "rightA">
Will the policy decision be  based purely on the results of the analysis, or is it just one of a wider set of considerations informing the decision? The more influential the analysis is, the more important it is to build in robust uncertainty analysis.
</div>
...
<div class = "leftB">
Check how the uncertainty will inform the decision-maker’s judgement
</div>
